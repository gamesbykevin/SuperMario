...
public final class GoombaWings extends Enemy
{
    ...
    public GoombaWings(final Random random)
    {
    ...
    {
        //walking animation
        super.addAnimation(State.Walking, 4, 0, 349, 20, 24, Timers.toNanoSeconds(100L), true);
        
        //stunned animation
        super.addAnimation(State.Stomped, 1, 80, 349, 16, 9, 0, false);
