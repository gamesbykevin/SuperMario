...
public final class GoombaBig extends Enemy
{
    /**
    ...
    {
        //walking animation
        super.addAnimation(State.Walking, 2, 0, 266, 24, 23, Timers.toNanoSeconds(250L), true);
        
        //stunned animation
        super.addAnimation(State.Stomped, 1, 48, 266, 24, 8, 0, false);
