...
public final class TurtleGreenWingsBig extends Enemy
{
    /**
    ...
    public TurtleGreenWingsBig(final Random random)
    {
    ...
    {
        //walking animation
        super.addAnimation(State.Walking, 4, 0, 141, 24, 31, Timers.toNanoSeconds(200L), true);
        
        //stunned animation
        super.addAnimation(State.Stunned, 1, 96, 141, 22, 22, 0, false);
        
        //shell kicked
        super.addAnimation(State.Kicked, 1, 96, 141, 22, 22, 0, false);
