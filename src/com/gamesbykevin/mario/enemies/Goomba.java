...
public final class Goomba extends Enemy
{
    ...
    public Goomba(final Random random)
    {
    ...
    {
        //walking animation
        super.addAnimation(State.Walking, 2, 0, 333, 16, 16, Timers.toNanoSeconds(250L), true);
        
        //stunned animation
        super.addAnimation(State.Stomped, 1, 32, 333, 16, 9, 0, false);
