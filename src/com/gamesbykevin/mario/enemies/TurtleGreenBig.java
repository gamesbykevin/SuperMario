...
public final class TurtleGreenBig extends Enemy
{
    ...
    public TurtleGreenBig(final Random random)
    {
    ...
    {
        //walking animation
        super.addAnimation(State.Walking, 2, 0, 110, 24, 31, Timers.toNanoSeconds(250L), true);
        
        //stunned animation
        super.addAnimation(State.Stunned, 1, 48, 110, 22, 22, 0, false);
        
        //shell kicked
        super.addAnimation(State.Kicked, 1, 48, 110, 22, 22, 0, false);
