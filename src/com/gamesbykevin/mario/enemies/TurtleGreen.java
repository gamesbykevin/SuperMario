...
public final class TurtleGreen extends Enemy
{
    /**
    ...
    public TurtleGreen(final Random random)
    {
    ...
    {
        //walking animation
        super.addAnimation(State.Walking, 2, 0, 0, 16, 27, Timers.toNanoSeconds(250L), true);
        
        //stunned animation
        super.addAnimation(State.Stunned, 1, 32, 0, 16, 16, 0, false);
        
        //shell kicked
        super.addAnimation(State.Kicked, 3, 48, 0, 16, 16, Timers.toNanoSeconds(150L), true);
