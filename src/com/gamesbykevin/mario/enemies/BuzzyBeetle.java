...
public final class BuzzyBeetle extends Enemy
{
    /**
    ...
    public BuzzyBeetle(final Random random)
    {
    ...
    {
        //walking animation
        super.addAnimation(State.Walking, 2, 0, 289, 16, 16, Timers.toNanoSeconds(250L), true);
        
        //stunned animation
        super.addAnimation(State.Stunned, 1, 32, 289, 16, 16, 0, false);
        
        //shell kicked
        super.addAnimation(State.Kicked, 2, 48, 289, 16, 16, Timers.toNanoSeconds(175L), true);
