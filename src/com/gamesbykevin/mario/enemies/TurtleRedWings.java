...
public final class TurtleRedWings extends Enemy
{
    ...
    private static final long DEFAULT_DURATON_STUNNED = Timers.toNanoSeconds(3500L);
    
    //different speeds for this enemy
    private static final double WALK_SPEED = 0.5;
    private static final double RUN_SPEED = 0.85;
    
    public TurtleRedWings(final Random random)
    {
        super(Enemy.DEFAULT_JUMP_VELOCITY * 1.75, WALK_SPEED, RUN_SPEED);
    ...
    {
        //walking animation
        super.addAnimation(State.Walking, 4, 0, 82, 16, 28, Timers.toNanoSeconds(200L), true);
        
        //stunned animation
        super.addAnimation(State.Stunned, 1, 64, 82, 16, 16, 0, false);
        
        //shell kicked
        super.addAnimation(State.Kicked, 3, 80, 82, 16, 16, Timers.toNanoSeconds(150L), true);
