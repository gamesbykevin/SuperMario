...
public final class TurtleGreenWings extends Enemy
{
    /**
    ...
    public TurtleGreenWings(final Random random)
    {
        super(Enemy.DEFAULT_JUMP_VELOCITY * 1.5, WALK_SPEED, RUN_SPEED);
    ...
    {
        //walking animation
        super.addAnimation(State.Walking, 4, 0, 54, 16, 28, Timers.toNanoSeconds(200L), true);
        
        //stunned animation
        super.addAnimation(State.Stunned, 1, 64, 54, 16, 16, 0, false);
        
        //shell kicked
        super.addAnimation(State.Kicked, 3, 80, 54, 16, 16, Timers.toNanoSeconds(150L), true);
